...
const fa: Dict = {
  ...
  plans: {
    ...
    signupDesc: "ترمینال بازار بدون سیگنال — دسترسی دائمی",
    signal: "سیگنال امروز",
  ...
  terminal: {
    ...
    dailyBody: "۲۰ PENGU برای ۲۴ ساعت دسترسی به سیگنال کامل روزانه — سبک‌ترین راه آزمودن موتور تحلیل.",
...
const en: Dict = {
  ...
  plans: {
    ...
    signupDesc: "Market terminal without signals — permanent access",
  ...
  terminal: {
    ...
    dailyBody: "20 PENGU for 24 hours of full daily-signal access — the lightest way to try the engine.",
